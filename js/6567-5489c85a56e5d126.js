"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[6567],{8719:function(a,b){let c=(a=300)=>{let b=-window.scrollY/(a/15),c=setInterval(()=>{0!==window.scrollY?window.scrollBy(0,b):clearInterval(c)},15)};b.Z=c},87302:function(a,b,c){c.d(b,{CKO:function(){return f.CK},Eep:function(){return d.Ee},VqE:function(){return d.Vq},X6q:function(){return d.X6},YE2:function(){return e.YE},kCb:function(){return d.kC},rUS:function(){return d.rU},rjZ:function(){return d.rj},"t$X":function(){return f.t$},ukE:function(){return d.uk},xuv:function(){return d.xu},xvT:function(){return d.xv}});var d=c(87043);c(82469);var e=c(69532);c(82709);var f=c(82753);c(12468)},38825:function(a,b,c){c.d(b,{Z:function(){return o}});var d=c(7896),e=c(31461),f=c(2784),g=c(99673),h=c(34490),i=c(82753),j=c(87043);let k=(0,g.ZP)(j.Yd)``,l=(0,g.ZP)(h.Xdw).attrs(a=>Object.assign({color:"#db44a7"},a))`
  width: ${({width:a})=>`${a}px`};
...
`,m=(0,e.ZP)(g.lO8).attrs(a=>({color:(0,f.uu)("lightest")(a)}))``;var n=c(82753);let o=({city:a,defaultText:b,formatter:c,iconHeight:e,iconWidth:f,state:g,text:h,zipcode:o})=>{let p=(0,n.RZ)({formatter:c,zipCode:o,zipCodeCity:a,zipCodeState:g,includeAddress:!1});return d.createElement(i,null,d.createElement(l,null,d.createElement(m,{width:f,height:e})),d.createElement(j,{"data-testid":"text-line"},o&&g&&a?d.createElement(d.Fragment,null,h," ",c?d.createElement(k,null,p):p):b))};o.defaultProps={city:void 0,formatter:void 0,iconHeight:void 0,iconWidth:void 0,state:void 0,zipcode:void 0};var p=o},82469:function(a,b,c){c.d(b,{iG:function(){return aM.Z},qE:function(){return m.Z},Ct:function(){return n.Z},lr:function(){return o.Z},g0:function(){return A},HS:function(){return B.Z},L2:function(){return C.Z},pl:function(){return aH},hU:function(){return E.Z},aV:function(){return I.Z},RG:function(){return aw},mY:function(){return O},dV:function(){return l},tA:function(){return P.Z},MS:function(){return Q.Z},lF:function(){return aR},Ee:function(){return aI.Z},me:function(){return R.Z},Cq:function(){return S.Z},qr:function(){return aO.Z},Mj:function(){return T.Z},KI:function(){return ag},kV:function(){return ah.Z},ok:function(){return aL},Rs:function(){return az},YQ:function(){return aN.Z}}),c(33309),c(52337);var d=c(7896),e=c(31461),f=c(2784),g=c(34490),h=c(87043),i=c(82753),j=c(12468);let k=a=>{let{restrictions:b={},height:c,fontSize:k,displayMode:l}=a,m=(0,e.Z)(a,["restrictions","height","fontSize","displayMode"]),[n,o]=(0,f.useState)({showTimer:!1,timeRemaining:""}),p=(0,f.useRef)(),q=l===j.IY,r=()=>{let a=(0,i.bd)(),{show:c,timeRemainingFormatted:d}=(0,i.lb)(b,a);o({showTimer:c,timeRemaining:d})};return(0,f.useEffect)(()=>{let a=()=>{r(),p.current=requestAnimationFrame(a)};return p.current=requestAnimationFrame(a),()=>cancelAnimationFrame(p.current)},[]),n.showTimer&&f.createElement(h.kC,(0,d.Z)({"data-testid":"offer-timer",borderRadius:2,justifyContent:"center",alignItems:"center",bg:"#EC7712",height:c,mt:[q&&1,2],mr:q?"10px":0},m),f.createElement(g.JO$,{color:"#FFF5F0",height:["12px","14px"],width:["12px","14px"],name:"Timer",mr:1}),f.createElement(h.xv,{color:"white",fontWeight:"medium",fontSize:k},"Oferta termina em ",n.timeRemaining))};k.defaultProps={height:"20px",fontSize:"10px",displayMode:j.IY};var l=k,m=c(78045);c(96504);var n=c(98460);c(67619);var o=c(49542);c(2761),c(84022),c(12241);var p=c(99673),q=c(91489),r=c(63825),s=c(19527);let t=(0,p.ZP)(s.Z)`
  display: flex;
  ...
  overflow-x: scroll;
`;(0,p.ZP)(r.Z)`
  color: ${a=>(0,q.uu)("scratched")(a)};
  display: block;
  margin-bottom: 8px;
  font-size: ${a=>(0,q.R)("fontSizes.0")(a)}px;
`;let u=(0,p.ZP)(s.Z)`
  display: flex;
  align-items: center;
  justify-content: center;
`,v=(0,p.ZP)(s.Z)`
  ...
  padding: 4px 16px;
  line-height: 1.17;
  color: ${a=>a.selected?(0,q.uu)("base")(a):(0,q.uu)("lightest")(a)};
  margin-right: 8px;
  background-color: ${a=>a.selected?(0,q.dF)("primary")(a):(0,q.dF)("lighter")(a)};
  border-radius: 20px;
  height: 38px;

  > svg {
    margin-right: 4px;
    fill: ${a=>a.selected?(0,q.uu)("lightest")(a):(0,q.uu)("base")(a)};
  }
  max-width: 144px;
`,w=(0,p.ZP)(r.Z)`
  width: 81px;
  ...
  font-stretch: normal;
  font-style: normal;
  line-height: ${a=>(0,q.R)("lineHeights.standard")(a)}px;
  letter-spacing: normal;
  color: ${a=>a.selected?(0,q.uu)("lightest")(a):(0,q.uu)("base")(a)};
`;function x({item:a,onChange:b}){let{slug:c,label:d,selected:e}=a;return f.createElement(v,{onClick:()=>b(!e&&c||null),selected:e,"data-testid":`opt-${c}`},(a=>{let b={"24c":g.f9j,delivery_plus_1:g._Ps,store_pickup:g.XqY,delivery_24h:g.Ju,delivery_1h:g.Gb7,"magalu-entregas":g.Erv,"magalu-partner":g.lO8,today:g.oFb},c=b[a]||g._Ps;return f.createElement(c,null)})(c),f.createElement(w,{selected:e},d))}x.defaultProps={item:{},onChange:null},(function({data:a,onChange:b}){let{items:c}=a;function d(a){b(a&&{type:"delivery_magalu",value:a})}return f.createElement(t,{carousel:(null==c?void 0:c.length)>2},f.createElement(u,null,null==c?void 0:c.map((a,b)=>f.createElement(x,{"data-testid":"filter-option",key:`filter-option-${a.slug}-${b}`,onChange:d,item:a}))))}).defaultProps={onChange:null};let y=(0,p.ZP)(h.rU).attrs(()=>({fontSize:2,fontWeight:"900",underlineOnHover:!0,hover:!0,padding:0,color:"primary.base"}))``,z=({data:a,handleClickLink:b})=>f.createElement(f.Fragment,null,null==a?void 0:a.map((a,c)=>"string"==typeof a?a:null!=a&&a.href?f.createElement(y,(0,d.Z)({key:c,"data-testid":"dynamic-text-link",href:null==a?void 0:a.href,onClick:c=>b(c,a)},a),null==a?void 0:a.value):f.createElement(h.xv,(0,d.Z)({key:c},a,{as:"span"}),null==a?void 0:a.value)));z.defaultProps={data:[],handleClickLink:()=>{}};var A=z,B=c(99554),C=c(1729),D=c(33055);c(2490);var E=c(15309);c(88887);let F=p.ZP.div`
  display: flex;
  flex-direction: column;
  align-items: center;
`,G={normal:p.iv`
    font-size: ${a=>(0,q.R)("fontSizes.2")(a)}px;
  `,big:p.iv`
    font-size: ${a=>(0,q.R)("fontSizes.4")(a)}px;
    font-weight: ${a=>(0,q.R)("fontWeights.bold")(a)};
  `},H=(0,p.ZP)(r.Z)`
  color: ${a=>(0,q.uu)("base")(a)};
  margin-bottom: 5px;

  ${a=>G[a.type]}
`;(function({label:a,type:b}){let c=Array.from([,,,,,].keys()),d="normal"===b?"30px":"40px";return f.createElement(F,null,f.createElement(H,{type:b,"data-testid":"title"},a),f.createElement("ul",null,c.map(a=>f.createElement(g.Uxw,{key:`star-${a}`,color:"#FFCC03",width:d,height:d}))))}).defaultProps={size:"30px",type:"normal"};var I=c(78012);c(33359),c(41065);var J=c(71180);let K=p.ZP.div`
  display: flex;
  align-items: center;
...
`,M=p.ZP.p`
  ...
  color: ${a=>a.color||"#fff"};
  margin: 0 5px;
`,N=({value:a,color:b,icon:c,textColor:d,onClick:e,hasInfo:h})=>f.createElement(K,{color:b,"data-testid":"loyalty",onClick:a=>{a.preventDefault(),a.stopPropagation()}},c&&f.createElement(g.JO$,{"data-testid":`${c}Icon`,name:c,width:"12px",height:"12px",color:"#fff"}),f.createElement(M,{color:d,"data-testid":"loyalty-value"},(0,J.oB)({value:parseFloat(a)})),h&&f.createElement(L,{"data-testid":"loyalty-info-button",onClick:e},f.createElement(g.JO$,{name:"HelpOutline",color:"none",width:"12px",height:"12px"})));N.defaultProps={hasInfo:!1,color:void 0};var O=N;c(28982),c(19620),c(81484),c(563);var P=c(23745),Q=c(58125),R=c(11151),S=c(73172),T=c(37222);c(57991);var U=c(97728);let V=p.iv`
  margin-right: 12px;
  flex-grow: 0;
  width: 30px;
  height: 30px;
...
`,ac=(0,p.ZP)(r.Z)`
  flex: 4;
  font-size: ${a=>(0,q.R)("fontSizes.1")(a)}px;
  font-weight: ${a=>(0,q.R)("fontWeights.medium")(a)};
  line-height: ${a=>(0,q.R)("lineHeights.big")(a)};
`,ad=(0,p.ZP)(r.Z)`
  display: block;
  font-size: ${a=>(0,q.R)("fontSizes.0")(a)}px;
  font-weight: ${a=>(0,q.R)("fontWeights.regular")(a)};
...
`,ae=(0,p.ZP)(r.Z)`
  ...
  font-size: ${a=>(0,q.R)("fontSizes.1")(a)}px;
  text-align: center;
  color: ${a=>{let{free:b}=a,c=(0,e.Z)(a,["free"]);return b?(0,q.ow)("secondary.base")(c):(0,q.ow)("text.base")(c)}};
  display: contents;
`,af=a=>{let{complement:b,description:c,price:g,currency:h,time:i,type:j,unit:k,freeShippingLabel:l}=a,m=(0,e.Z)(a,["complement","description","price","currency","time","type","unit","freeShippingLabel"]);return f.createElement(W,(0,d.Z)({"data-testid":"shipping-item"},m),["store_pickup","pickup_point"].includes(j)&&f.createElement(Y,{fill:"background.dark"})||(a=>{let b=(0,U.Z)({currency:h});return b?f.createElement(ab,{fill:a}):"hours"===k&&i<=2?f.createElement(aa,{fill:a}):"days"===k&&0===i?f.createElement(Z,{fill:a}):"days"===k&&1===i?f.createElement($,{fill:a}):"working_days"===k&&1===i?f.createElement(_,{fill:a}):!b&&f.createElement(X,{fill:a})})("background.dark"),f.createElement(ac,null,c,f.createElement(ad,{as:"span"},b)),!!Number(g)&&f.createElement(ae,null,(0,J.oB)({value:g}))||f.createElement(ae,{free:!0},l))};af.defaultProps={freeShippingLabel:"Frete Gr\xe1tis",unit:""};var ag=af,ah=c(15185);c(50919);var ai=c(84546);let aj=p.ZP.div`
  display: grid;
  grid-column-gap: 5px;
  grid-row-gap: 8px;
  grid-template-columns: repeat(3, 1fr);
`,ak=(0,p.ZP)(r.Z).attrs({fontWeight:"bold",fontSize:3,color:"primary",mb:2})``,al=({recommends:a,title:b})=>f.createElement(ai.Z,null,f.createElement(r.Z,{fontSize:4,mb:4},b),f.createElement(aj,null,a.map((a,b)=>f.createElement(ai.Z,{key:b},f.createElement(ak,null,a.name),f.createElement(r.Z,null,a.city),f.createElement(S.Z,{score:a.score}),f.createElement(r.Z,{lineHeight:1},a.text)))));al.defaultProps={recommends:[],title:""};var am=c(68054);let an=p.ZP.div`
  display: flex;
  width: 100%;
  height: 100%;
  align-items: center;
  ${am.$_}
  ${am.GQ}
`,ao=(0,p.ZP)(ai.Z)``,ap=(0,p.ZP)(ai.Z).attrs(a=>Object.assign({color:"text.white",fontWeight:"bold",fontSize:0},a))`
  ${q.$_}
`,aq=(0,p.ZP)(h.rU).attrs(a=>Object.assign({color:"text.white",fontSize:0,p:0},a))``,ar=a=>{let{message:{text:b=""}={},loginLink:{text:c="Entre ou cadastre-se",url:g="#"}={}}=a,h=(0,e.Z)(a.message,["text"]),i=(0,e.Z)(a.loginLink,["text","url"]);return f.createElement(ao,{"data-testid":"stereo-login_menu-unsigned_user_state-container"},b&&f.createElement(ap,h,b),f.createElement(aq,(0,d.Z)({href:g},i),c))};ar.defaultProps={message:{},loginLink:{}};var as=ar;let at=({username:a,welcomeMessage:b,logoutMessage:c,signOutUrl:d,menuLinks:e=[],onLogout:g})=>f.createElement(h.Lt,{mouseenter:!0,pointing:!0},f.createElement(h.Lt.Title,{color:"text.white",fill:"background.lighter"},b||f.createElement("span",null,"Ol\xe1, ",f.createElement("b",null,a))),f.createElement(h.Lt.Menu,{pointing:!0,fontSize:0,p:2},e.map(({icon:a,label:b,url:c},d)=>f.createElement(h.Lt.Item,{key:d,startIcon:a,p:1,my:2},f.createElement(h.rU,{href:c,fontSize:0},b))),f.createElement(h.Lt.Divider,null),f.createElement(h.Lt.Item,{p:1,my:2,disableHover:!0},c||`N\xe3o \xe9 ${a}? `,f.createElement(h.rU,{underline:!0,px:0,fontSize:0,href:d,onClick:g,"data-testid":"link-logout"},"Sair"))));at.defaultProps={welcomeMessage:"",logoutMessage:"",signOutUrl:""};var au=at;let av=({isSignedIn:a,unsignedConfig:b,signedConfig:c,signOutUrl:e,onLogout:g})=>f.createElement(an,null,a?f.createElement(au,(0,d.Z)({},c,{signOutUrl:e,onLogout:g})):f.createElement(as,b));av.defaultProps={isSignedIn:!1,unsignedConfig:{},signedConfig:{},onLogout:()=>{},signOutUrl:""};var aw=av;let ax=p.ZP.div`
  & > svg {
    transform: scale(1.2);
  }
`,ay=({amount:a,nullable:b,truncateAmountThreshold:c,backgroundColor:d,counterColor:e="#db44a7",fontColor:i="#fff",iconColor:j="#fff",onClick:k})=>f.createElement(h.fG,{amount:a,nullable:b,truncateAmountThreshold:c,backgroundColor:d,counterColor:e,fontColor:i,onClick:k},f.createElement(ax,null,f.createElement(g.Xdw,{color:j})));ay.defaultProps={amount:0,onClick:()=>{},nullable:!0};var az=ay,aA=c(10200);let aB=p.ZP.ul`
  display: grid;
  grid-auto-flow: column;
  grid-column-gap: ${(0,q.R)("space.3")}px;
  margin-right: 8px;
`,aC=p.ZP.li`
  list-style: none;
`,aD={color:"text.greyishBlue",fontSize:[0,0,0,1],fontWeight:["bold","bold","bold","regular"]},aE=(0,p.ZP)(aA.Z).attrs(a=>Object.assign({p:0},aD,a))`
  ${q.$_}
  ${am.cp}
`,aF=p.ZP.span.attrs(a=>Object.assign({},aD,a))`
  ${q.$_}
  ${am.cp}
`,aG=({data:a})=>{let{linksList:b=[]}=a;return f.createElement(aB,{"data-testid":"horizontal-links-elem"},b.map((a,b)=>f.createElement(aC,{key:`link-item-${b}`},a.url?f.createElement(aE,{href:a.url},a.label):f.createElement(aF,null,a.label))))};aG.defaultProps={data:{linksList:[]}};var aH=aG,aI=c(65055);c(51382);let aJ=p.ZP.form``;aJ.Link=(0,p.ZP)(h.rU).attrs(a=>Object.assign({color:"text.lightest"},a))`
  ${q.$_}
`,aJ.Header=p.ZP.div.attrs(a=>Object.assign({color:"text.lightest",fontSize:0},a))`
  display: flex;
  align-items: center;

  svg {
    margin-right: ${(0,q.R)("space.1")}px;
  }

  ${aJ.Link} {
    color: ${(0,q.R)("colors.lightBlue")};
    ${am.cp}
  }

  ${q.$_};
`,aJ.Title=p.ZP.h2.attrs(a=>Object.assign({fontSize:2,fontWeight:"medium",color:"text.lightest"},a))`
  ${q.$_}
  ${am.cp}
`,aJ.InputWrapper=p.ZP.div.attrs(a=>Object.assign({p:"1"},a))`
  display: flex;
  align-items: center;
  ${am.Dh}
`,aJ.Input=(0,p.ZP)(h.II).attrs(a=>Object.assign({mr:"2"},a))`
  ${am.Dh}
`,aJ.SubmitBtn=(0,p.ZP)(h.zx).attrs(a=>Object.assign({color:"secondary",size:"small",m:"10px 0"},a))``;let aK=({title:a,policy:b,onSubmitForm:c})=>{let[d,e]=(0,f.useState)(""),[h,i]=(0,f.useState)(""),j=(a,b)=>{b(a,{name:d,email:h})};return f.createElement(aJ,{"data-testid":"subscription-form-elem",onSubmit:a=>j(a,c)},f.createElement(aJ.Header,null,f.createElement(g.TbV,{"data-testid":"link-icon",color:"currentColor",width:25}),f.createElement(aJ.Title,null,a),f.createElement(aJ.Link,{"data-testid":"link-policy",underline:!0,href:null==b?void 0:b.url},null==b?void 0:b.label)),f.createElement(aJ.InputWrapper,null,f.createElement(D.Z,{text:"digite o seu nome",htmlFor:"input-name"}),f.createElement(aJ.Input,{id:"input-name","data-testid":"input-name",placeholder:"digite o seu nome",value:d,onChange:a=>e(a.target.value)}),f.createElement(D.Z,{text:"digite o seu email",htmlFor:"input-email"}),f.createElement(aJ.Input,{id:"input-email","data-testid":"input-email",placeholder:"digite o seu email",type:"email",value:h,onChange:a=>i(a.target.value)}),f.createElement(aJ.SubmitBtn,{"data-testid":"submit-btn",disabled:!h||!d,type:"submit",onClick:a=>j(a,c)},"Enviar")))};var aL=aK,aM=c(38825);c(41237);var aN=c(1587),aO=c(27408);let aP=(0,p.ZP)(h.xv)`
  font-size: ${a=>(0,q.R)("fontSizes.0")(a)}px;
  color: ${(0,q.uu)("scratched")};
  text-align: ${({textAlign:a})=>a};

  span {
    color: ${(0,q.R)("palette.secondary.dark")};
    font-weight: ${(0,q.R)("fontWeights.bold")};
  }
`,aQ=()=>f.createElement("span",null,"Frete gr\xe1tis");var aR=function({cost:a,displayMode:b,costDescription:c}){return f.createElement(f.Fragment,null,a?f.createElement(aP,{"data-testid":"shipping-cost",textAlign:b===j.Co?"center":null},0===Number(a)?f.createElement(aQ,null):c):null)}}}])
//# sourceMappingURL=6567-5489c85a56e5d126.js.map